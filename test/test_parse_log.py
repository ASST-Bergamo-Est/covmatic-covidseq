...
TEST_LOGFILE_V63 = get_path('assets', 'example_otapp_v6.3_log.json')
...
class LogParseCreation(LogParseBaseClass):
    ...
    def load_testfile(self):
        self._testfile = TEST_LOGFILE

    def test_file_exist(self):
        self.assertTrue(os.path.isfile(self._testfile))

    def test_parse(self):
        parse(self._testfile, TEST_OUTPUTFILE)
...
class LogParseCreationV63(LogParseCreation):
    def load_testfile(self):
        self._testfile = TEST_LOGFILE_V63
...
class TestLogCreatedV63(TestLogCreated):
    def load_testfile(self):
        self._testfile = TEST_LOGFILE_V63
